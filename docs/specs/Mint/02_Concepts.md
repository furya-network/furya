...
Unlike the default Mint Module of Cosmos-SDK which can vary the inflation rate dynamically based on the ratio of bonded and unbonded tokens at any point in time, the Mint module of the FURYA-Network chain follows a strict regime of inflation rates defined as phases

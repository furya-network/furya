...
import (
	...
	"github.com/furya-network/furya/app/params"
	"github.com/furya-network/furya/utils"
	dvmtypes "github.com/furya-network/furya/x/dvm/types"
	mintmoduletypes "github.com/furya-network/furya/x/mint/types"
	strategicreservetypes "github.com/furya-network/furya/x/strategicreserve/types"
...
// TestApp is used as a container of the furya app
type TestApp struct {
	app.FuryaApp
}
...
func setup(withGenesis bool, invCheckPeriod uint) (*TestApp, app.GenesisState) {
	...
	appInstance := app.NewFuryaApp(log.NewNopLogger(), db, nil, true, map[int64]bool{}, "", invCheckPeriod, encCdc,
		sdksimapp.EmptyAppOptions{})
	if withGenesis {
		return &TestApp{FuryaApp: *appInstance}, app.NewDefaultGenesisState()
	}
	return &TestApp{FuryaApp: *appInstance}, app.GenesisState{}
}

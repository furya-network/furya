...
// source: furya/house/withdraw.proto
...
type Withdrawal struct {
	...
	Mode WithdrawalMode `protobuf:"varint,5,opt,name=mode,proto3,enum=furyanetwork.furya.house.WithdrawalMode" json:"mode,omitempty" yaml:"mode"`
...
func init() {
	proto.RegisterEnum("furyanetwork.furya.house.WithdrawalMode", WithdrawalMode_name, WithdrawalMode_value)
	proto.RegisterType((*Withdrawal)(nil), "furyanetwork.furya.house.Withdrawal")
}

...
// source: furya/house/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "furyanetwork.furya.house.GenesisState")
}

func init() { proto.RegisterFile("furya/house/genesis.proto", fileDescriptor_aa4dcd3bb98435db) }

...
Example:
$ %s query strategicreserve participation-exposures %s
`,
...
Example:
$ %s query strategicreserve participation-exposure %s %d
`,
...
Example:
$ %s query strategicreserve historical-participation-exposures %s
`,
				version.AppName, "5531c60f-2025-48ce-ae79-1dc110f16000",
			),
		),
...
Example:
$ %s query strategicreserve participation-bets %s %d
`,

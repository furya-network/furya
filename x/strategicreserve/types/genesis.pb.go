...
// source: furya/strategicreserve/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "furyanetwork.furya.strategicreserve.GenesisState")
}

func init() {
	proto.RegisterFile("furya/strategicreserve/genesis.proto", fileDescriptor_708845e0eb254a47)
}

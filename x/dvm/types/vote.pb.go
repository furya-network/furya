...
func init() {
	proto.RegisterEnum("furyanetwork.furya.dvm.ProposalVote", ProposalVote_name, ProposalVote_value)
	proto.RegisterType((*Vote)(nil), "furyanetwork.furya.dvm.Vote")
}

func init() { proto.RegisterFile("furya/dvm/vote.proto", fileDescriptor_c881d83c5c5286a5) }

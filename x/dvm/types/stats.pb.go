...
func init() {
	proto.RegisterType((*ProposalStats)(nil), "furyanetwork.furya.dvm.ProposalStats")
}

func init() { proto.RegisterFile("furya/dvm/stats.proto", fileDescriptor_18b1583139df99d6) }

...
// source: furya/dvm/proposal.proto
...
type PublicKeysChangeFinishedProposal struct {
	...
	Result ProposalResult `protobuf:"varint,2,opt,name=result,proto3,enum=furyanetwork.furya.dvm.ProposalResult" json:"result,omitempty"`
...
func init() {
	proto.RegisterEnum("furyanetwork.furya.dvm.ProposalResult", ProposalResult_name, ProposalResult_value)
	proto.RegisterType((*PublicKeysChangeProposal)(nil), "furyanetwork.furya.dvm.PublicKeysChangeProposal")
	proto.RegisterType((*PublicKeysChangeFinishedProposal)(nil), "furyanetwork.furya.dvm.PublicKeysChangeFinishedProposal")
}

func init() { proto.RegisterFile("furya/dvm/proposal.proto", fileDescriptor_29058a11b4a243d6) }

...
func init() {
	proto.RegisterType((*MsgSubmitPubkeysChangeProposalRequest)(nil), "furyanetwork.furya.dvm.MsgSubmitPubkeysChangeProposalRequest")
	proto.RegisterType((*MsgSubmitPubkeysChangeProposalResponse)(nil), "furyanetwork.furya.dvm.MsgSubmitPubkeysChangeProposalResponse")
	proto.RegisterType((*MsgVotePubkeysChangeRequest)(nil), "furyanetwork.furya.dvm.MsgVotePubkeysChangeRequest")
	proto.RegisterType((*MsgVotePubkeysChangeResponse)(nil), "furyanetwork.furya.dvm.MsgVotePubkeysChangeResponse")
}

func init() { proto.RegisterFile("furya/dvm/tx.proto", fileDescriptor_78e7f1885428b6a5) }
...
func (c *msgClient) SubmitPubkeysChangeProposal(ctx context.Context, in *MsgSubmitPubkeysChangeProposalRequest, opts ...grpc.CallOption) (*MsgSubmitPubkeysChangeProposalResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyanetwork.furya.dvm.Msg/SubmitPubkeysChangeProposal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) VotePubkeysChange(ctx context.Context, in *MsgVotePubkeysChangeRequest, opts ...grpc.CallOption) (*MsgVotePubkeysChangeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyanetwork.furya.dvm.Msg/VotePubkeysChange", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_VotePubkeysChange_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyanetwork.furya.dvm.Msg/VotePubkeysChange",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furyanetwork.furya.dvm.Msg",

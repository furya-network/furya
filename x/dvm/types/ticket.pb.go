...
type ProposalVotePayload struct {
	...
	Vote ProposalVote `protobuf:"varint,2,opt,name=vote,proto3,enum=furyanetwork.furya.dvm.ProposalVote" json:"vote,omitempty"`
}
...
func init() {
	proto.RegisterType((*PubkeysChangeProposalPayload)(nil), "furyanetwork.furya.dvm.PubkeysChangeProposalPayload")
	proto.RegisterType((*ProposalVotePayload)(nil), "furyanetwork.furya.dvm.ProposalVotePayload")
}

func init() { proto.RegisterFile("furya/dvm/ticket.proto", fileDescriptor_7121f0f264448d06) }

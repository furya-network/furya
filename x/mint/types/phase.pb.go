...
func init() {
	proto.RegisterType((*Phase)(nil), "furyanetwork.furya.mint.Phase")
}

func init() { proto.RegisterFile("furya/mint/phase.proto", fileDescriptor_7fc2241b526dba74) }

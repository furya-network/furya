...
// source: furya/mint/minter.proto
...
func init() {
	proto.RegisterType((*Minter)(nil), "furyanetwork.furya.mint.Minter")
}

func init() { proto.RegisterFile("furya/mint/minter.proto", fileDescriptor_d31ed0ee2430eeec) }

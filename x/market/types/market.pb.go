...
// source: furya/market/market.proto
...
func init() {
	proto.RegisterEnum("furyanetwork.furya.market.MarketStatus", MarketStatus_name, MarketStatus_value)
	proto.RegisterType((*Market)(nil), "furyanetwork.furya.market.Market")
	proto.RegisterType((*MarketBetConstraints)(nil), "furyanetwork.furya.market.MarketBetConstraints")
}

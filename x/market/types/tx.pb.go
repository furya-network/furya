...
func init() {
	proto.RegisterType((*MsgAddMarket)(nil), "furyanetwork.furya.market.MsgAddMarket")
	proto.RegisterType((*MsgAddMarketResponse)(nil), "furyanetwork.furya.market.MsgAddMarketResponse")
	proto.RegisterType((*MsgResolveMarket)(nil), "furyanetwork.furya.market.MsgResolveMarket")
	proto.RegisterType((*MsgResolveMarketResponse)(nil), "furyanetwork.furya.market.MsgResolveMarketResponse")
	proto.RegisterType((*MsgUpdateMarket)(nil), "furyanetwork.furya.market.MsgUpdateMarket")
	proto.RegisterType((*MsgUpdateMarketResponse)(nil), "furyanetwork.furya.market.MsgUpdateMarketResponse")
}

func init() { proto.RegisterFile("furya/market/tx.proto", fileDescriptor_d0e875658c4f19fd) }
...
func (c *msgClient) AddMarket(ctx context.Context, in *MsgAddMarket, opts ...grpc.CallOption) (*MsgAddMarketResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyanetwork.furya.market.Msg/AddMarket", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ResolveMarket(ctx context.Context, in *MsgResolveMarket, opts ...grpc.CallOption) (*MsgResolveMarketResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyanetwork.furya.market.Msg/ResolveMarket", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateMarket(ctx context.Context, in *MsgUpdateMarket, opts ...grpc.CallOption) (*MsgUpdateMarketResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyanetwork.furya.market.Msg/UpdateMarket", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AddMarket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyanetwork.furya.market.Msg/AddMarket",
	}
...
func _Msg_ResolveMarket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyanetwork.furya.market.Msg/ResolveMarket",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UpdateMarket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyanetwork.furya.market.Msg/UpdateMarket",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furyanetwork.furya.market.Msg",
	...
	Metadata: "furya/market/tx.proto",
}

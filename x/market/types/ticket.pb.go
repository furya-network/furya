...
// source: furya/market/ticket.proto
...
type MarketAddTicketPayload struct {
	...
	Status MarketStatus `protobuf:"varint,5,opt,name=status,proto3,enum=furyanetwork.furya.market.MarketStatus" json:"status,omitempty"`
...
type MarketUpdateTicketPayload struct {
	...
	Status MarketStatus `protobuf:"varint,6,opt,name=status,proto3,enum=furyanetwork.furya.market.MarketStatus" json:"status,omitempty"`
}
...
type MarketResolutionTicketPayload struct {
	...
	// status is the status of the resolution.
	Status MarketStatus `protobuf:"varint,4,opt,name=status,proto3,enum=furyanetwork.furya.market.MarketStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterType((*MarketAddTicketPayload)(nil), "furyanetwork.furya.market.MarketAddTicketPayload")
	proto.RegisterType((*MarketUpdateTicketPayload)(nil), "furyanetwork.furya.market.MarketUpdateTicketPayload")
	proto.RegisterType((*MarketResolutionTicketPayload)(nil), "furyanetwork.furya.market.MarketResolutionTicketPayload")
}

func init() { proto.RegisterFile("furya/market/ticket.proto", fileDescriptor_1dc46cd902954700) }

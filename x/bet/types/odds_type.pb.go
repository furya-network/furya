...
// source: furya/bet/odds_type.proto
...
func init() {
	proto.RegisterEnum("furyanetwork.furya.bet.OddsType", OddsType_name, OddsType_value)
}

func init() { proto.RegisterFile("furya/bet/odds_type.proto", fileDescriptor_9054da535c81741c) }

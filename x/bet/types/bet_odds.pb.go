...
// source: furya/bet/bet_odds.proto
...
func init() {
	proto.RegisterType((*BetOdds)(nil), "furyanetwork.furya.bet.BetOdds")
}

func init() { proto.RegisterFile("furya/bet/bet_odds.proto", fileDescriptor_2629a03d0a23fb04) }
